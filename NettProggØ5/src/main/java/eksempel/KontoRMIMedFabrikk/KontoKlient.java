...
class KontoKlient {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Konto k2 = fabrikk.lagKonto(33345678L, "øshild Jensen", 6000);

        k1.gjørTransaksjon(600);
        k2.gjørTransaksjon(1000);

        System.out.println("Kontonr: " + k1.finnKontonr() + ", navn: " + k1.finnNavn() + ", saldo: " + k1.finnSaldo());
        System.out.println("Kontonr: " + k2.finnKontonr() + ", navn: " + k2.finnNavn() + ", saldo: " + k2.finnSaldo());
    }
}